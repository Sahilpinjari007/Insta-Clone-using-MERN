...
import './CheckFollowingDailog.css'
import UserCards from "../userCards/userCards";
import { useNavigate } from "react-router-dom";
import { AppContext } from "../../Context/context";
import { getUserFollowings } from "../../action/curUser";
import RemoveFollowDailog from "../RemoveFollowDailog/RemoveFollowDailog";

const CheckFollowingDailog = () => {
            ...
            <div className="dailog-content">
                {
                  followUsers?.map((elem, i) => {
                    return <UserCards from={'following'} setShowRemoveFollowDailog={setShowRemoveFollowDailog} setDailogData={setDailogData} key={i} data={elem} />
                  })
                }
              </div>
          </div>
...
export default CheckFollowingDailog;
