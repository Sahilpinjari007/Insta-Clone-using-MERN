...
import { checkUserFollowed, getUser } from "../../action/curUser";
    ...
    <div className="comment">
      <div className="comment-content">
        <div className="comment-user-profile-img-layout">
          <div className="comment-user-profile-img">
            <img src="/insta imgs/asset 2.jpeg" alt="" />
          </div>
        </div>

        <div className="comment-meta">
          <div className="comment-user-name">
            <span>mr.adityashirsat</span>
          </div>
...
const ViewUserMedia = () => {
  const { setViewUserMedia, viewUserMediaData, authUser } =
  ...
  const [multiplePosts, setMultiplePosts] = useState([
    { url: "/insta imgs/viewpost.jpeg" },
    { url: "/insta imgs/viewposts.jpeg" },
    { url: "/insta imgs/instapo.jpeg" },
  ]);
  ...
  const handlePostLike = () => {
    setIsPostLiked((priVal) => !priVal);
  };

  const handlePostSaved = () => {
    setIsPostSaved((priVal) => !priVal);
  };
  ...
  // console.log(viewUserMediaData);

  const getPostUser = async () => {
    const response = await getUser(viewUserMediaData.postUserUserId);
    setPostUser(response.result);
    checkUserFollowedOrNot(response.result.userId);
  };

  const checkUserFollowedOrNot = async (postUserId) => {

    if(postUserId === authUser.userId) return;
    
    const response = await checkUserFollowed({
      followerUserId: postUserId,
                  ...
                  {viewUserMediaData.postType === "img" ? (
                    <div className="img-media-content">
                      <div className="viewUserMedia-img-layout">
                        <img
                          draggable={false}
                          src={multiplePosts[currentImgIndex].url}
                          alt=""
                        />
                      </div>
                    </div>
                    ...
                    <div className="video-media-content">
                      ...
                      <video
                        ...
                        ref={videoMedia}
                        src="http://localhost:5000/storage/180a8a24-39e5-42c4-827f-a890ee1b945c.mp4"
                      ></video>
                    </div>
                  )}
              ...
              <div className="viewUserMedia-media-meta-data-section">
                <header className="viewUserMedia-meta-header">
                  <div className="viewUserMedia-meta-header-content">
                    ...
                    <span className="viewUserMedia-meta-follow-btn">
                      Follow
                    </span>
                ...
                <div className="viewUserMedia-meta-add-comment-section">
                  <div className="viewUserMedia-meta-add-comment-content">
                    ...
                    <div className="viewUserMedia-media-comment-post-btn">
                      <span>Post</span>
                    </div>
                  </div>
                </div>
